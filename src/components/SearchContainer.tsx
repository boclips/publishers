...
const SearchContainer = () => {
  return (
    <div class="bg-primary-light h-auto rounded-lg my-12">
      <div class="grid grid-cols-5">
        <div class="col-span-3 mt-32 ml-16">
          <h1 class="mb-8 text-4xl font-medium">
            What video do you need today?
          </h1>
          <div class="h-14 w-11/12 p-1 rounded border-solid border-2 bg-white flex focus-within:shadow-outline hover:shadow-outline">
            <input
              placeholder="Search by topic or keyword"
              class="h-full w-full ml-2 focus:outline-none"
            />
            <button class="w-48 text-white bg-primary rounded font-medium text-lg hover:bg-primary-hover active:bg-primary-active focus:shadow-button-focus focus:outline-none">
        ...
        <div class="col-span-2 my-16 mx-6">
          <img src="./assets/home-image.svg" width="352" height="331" />
        </div>
      </div>
    </div>
  )
